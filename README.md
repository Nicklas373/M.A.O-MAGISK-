...
This package will restore AudioPolicyManager libs and updated audio config to your system, include CAF audio blobs and enable some audio high quality features on mido (WCD9335).
